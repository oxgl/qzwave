    ...
    class DeviceSpecificReport(
        ...
        companion object {
            ...
            suspend fun deserialize(
                ...
                context: DeserializableCommandContext
                ...
                return if (dataFormat == DATA_FORMAT_UTF_8) {
                    DeviceSpecificReport(
                        deviceIDType,
                        inputStream.getNBytes(dataLength).toString(Charsets.UTF_8),
                        null
                    )
                } else {
                    return DeviceSpecificReport(deviceIDType, null, inputStream.getNBytes(dataLength))
                }
            }
        }
    }
